...
const interactionCircleHitboxRadius = 80; // Radius of interaction circle hitbox
...
const dotColor = 'wheat'; // Color of dots
const dotTouchColor = 'wheat'; // Color of dots when touched by interaction circle
